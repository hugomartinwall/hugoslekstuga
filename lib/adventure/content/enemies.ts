...
export const ENEMY_KINDS: Record<string, EnemyDef> = {
  ...
  // ---- world 3: the canals ------------------------------------------
  crab: { name: "crab", arch: "chaser", hp: 5, speed: 52, r: 7, coins: 2, touchDmg: 2 },
  ...
  // ---- world 4: the bog ---------------------------------------------
  leech: { name: "leech", arch: "chaser", hp: 5, speed: 40, r: 7, coins: 2, touchDmg: 2, flags: ["bogfast"] },
  ...
  imp: { name: "freezer imp", arch: "chaser", hp: 6, speed: 54, r: 7, coins: 2, touchDmg: 2, flags: ["crampons"] },
  ...
  // ---- world 6: the furnace -----------------------------------------
  slagpup: { name: "slag pup", arch: "chaser", hp: 6, speed: 56, r: 7, coins: 2, touchDmg: 2 },
  ...
  // ---- world 7: the dunes -------------------------------------------
  scarab: { name: "scarab", arch: "chaser", hp: 6, speed: 58, r: 7, coins: 2, touchDmg: 2 },
  ...
  // ---- world 8: the crypt -------------------------------------------
  ghoul: { name: "ghoul", arch: "chaser", hp: 7, speed: 52, r: 7, coins: 2, touchDmg: 2 },
  ghost: { name: "ghost", arch: "chaser", hp: 6, speed: 48, r: 7, coins: 3, touchDmg: 2, flags: ["phasedark"] },
  ...
  glitch: { name: "glitch", arch: "chaser", hp: 8, speed: 59, r: 7, coins: 3, touchDmg: 2 },
...
export const MINION_KINDS: Record<string, EnemyDef> = {
  shard: { name: "shard", arch: "chaser", hp: 2, speed: 68, r: 5, coins: 1, touchDmg: 2 },
  litter: { name: "litter", arch: "chaser", hp: 2, speed: 60, r: 5, coins: 1, touchDmg: 2 },
  cartling: { name: "cartling", arch: "chaser", hp: 4, speed: 52, r: 6, coins: 1, touchDmg: 2 },
  addSapling: { name: "sapling", arch: "chaser", hp: 3, speed: 51, r: 6, coins: 1, touchDmg: 2 },
};
