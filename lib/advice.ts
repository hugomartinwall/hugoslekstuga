...
export const advice: string[] = [
  ...
  "Wanting pulls you off the path you came to walk.",
  "Carry a grudge far enough and it becomes the room you live in.",
  "A mind on every branch is at home on none.",
  "Doubt isn't thinking. It's thinking refusing to end.",
  "You can't outrun a feeling you haven't named.",
  "What you refuse to feel runs your day from underneath.",
  "Look at anger long enough and it admits it was fear.",
  "You are not your thoughts. You are who notices them.",
  "Two ways to fail a path: not stepping on it, and stepping off.",
  "Outside answers don't reach inside questions.",
  "Other people's paths look easier because you can't feel their gravel.",
  "Clarity isn't seeing more. It's seeing what's connected.",
  "The body keeps receipts the mind threw away.",
  "Most of what you call confusion is noise you haven't muted.",
  "Sit still long enough and you'll notice you've been chasing nothing.",
];
